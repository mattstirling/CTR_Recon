...
if session == 'var':
    ...
    list_filenames_to_skip = (['__bns__derivProdData__riskWatch__Mocatta__baseMetals__RW__deals__day1__Counterparty_static.csv',
                               ...
                               '__bns__var_rw__storage__position__inverlat__mdpraptipobase.csv.20160816.0',
                               '__bns__var_rw__storage__position__inverlat__tesoreria_md_tipobase.csv.20160816.0',
