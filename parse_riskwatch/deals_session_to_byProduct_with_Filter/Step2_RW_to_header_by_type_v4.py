...
if session == 'var':
    #main folder
    parent_folder = 'C:/Users/mstirling/Desktop/Shared/RW/VAR Session/market.16.08.16/'
...
#only some headers are in scope
#we have commented out code where we scan the file for headers and use this manual input as the set of headers. 
headers_in_scope = ['BNS Swap']
set_header_type = set(headers_in_scope)
