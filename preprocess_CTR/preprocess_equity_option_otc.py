...
in_folder = 'C:\Users\mstirling\Desktop\Shared\RW\CTR Files\RW_ECR_Release_12\CTR_output_file\out_K2_Asset_Option\mtm_compare/'.replace('\\', '/')
in_file = 'K2_Equity_OptionOTC_D_20170131_2_RiskWatch.csv'
