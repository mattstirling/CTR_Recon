...
in_folder = 'C:\Users\mstirling\Desktop\Shared\RW\CTR Files\RW_ECR_Release_12\CTR_output_file\out_K2_Funding_Ticket\mtm_compare/'.replace('\\', '/')
in_file = 'K2_Funding_Ticket_D_20170131_2_RiskWatch.csv'
...
#df['Rec Rate'] = [preprocess_ETL.rec_rate_funding_ticket_correction('a','b','c','d') for [a,b,c,d] in df_rec_rate.itertuples()]

df['Rec Rate'] = (preprocess_ETL.rec_rate_funding_ticket_correction(df['Rec Rate']
                                                                    ,df['Rec Fixed Flag']
                                                                    ,df['Rec Fixed Rates']
                                                                    ,df['Rec Spread']))

df['Rec 1st Roll Date'] = df['Pay 1st Roll Date']
